#include "org_thoughtcrime_redphone_codec_SpeexCodec.h"
...
JNIEXPORT jint JNICALL Java_org_thoughtcrime_redphone_codec_SpeexCodec_openSpeex (JNIEnv *env, jobject obj){
