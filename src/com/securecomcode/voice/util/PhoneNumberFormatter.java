...
public class PhoneNumberFormatter {
    ...
    public static String formatNumber(Context context, String number) {
        ...
        if(PreferenceManager.getDefaultSharedPreferences(context).getString(Constants.REG_OPTION_SELECTED, "").equalsIgnoreCase("Email")){
            if(Util.isValidEmail(localNumber)){
                String countryCode = PreferenceManager.getDefaultSharedPreferences(context).getString(Constants.COUNTRY_CODE_SELECTED, "");
                localNumber =  "+" + countryCode + Util.NUMBER_FORMAT_HELPER;
            }
        }
